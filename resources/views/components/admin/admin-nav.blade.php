...
<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        <a href="{{ route('dashboard') }}">
            <img alt="Logo" src="{{ asset('admin/assets/media/logos/deal-station-logo.png') }}"
                class="h-50px logo" />
        </a>
        <!--end::Logo-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                @can('admin-report-list')
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion" id="reportNav">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            <div class="menu-item">
                                <a class="menu-link" id="offerReportNav" href="{{ route('reports.redeemed-coupons') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">{{ __('Redeemed Coupons') }}</span>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                @canany(['admin-merchant-list', 'admin-branch-list', 'admin-offer-list'])
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion" id="moNav">
                        <span class="menu-link">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Commode2.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="menu-title">{{ __('Merchant & Offers') }}</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            @can('admin-merchant-list')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('merchants.index') }}" id="merchantNav">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('Merchants') }}</span>
                                    </a>
                                </div>
                            @endcan
                            ...
                            @can('admin-branch-list')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('branches.index') }}" id="branchNav">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('admin-offer-list')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('offers.index') }}" id="offerNav">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                ...
                @canany(['admin-city-list', 'admin-category-list', 'admin-campaign-list', 'admin-advertisement-list'])
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion" id="appNav">
                        <span class="menu-link">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-primary svg-icon-2x">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        ...
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <rect fill="#000000" x="10" y="16" width="4"
                                                height="4" rx="1" />
                                            <rect fill="#000000" opacity="0.3" x="10" y="10"
                                                width="4" height="4" rx="1" />
                                            <rect fill="#000000" x="4" y="4" width="4"
                                                height="4" rx="1" />
                            ...
                            <span class="menu-title">{{ __('App') }}</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            ...
                            @can('admin-city-list')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('cities.index') }}" id="cityNav">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('admin-category-list')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('categories.index') }}" id="categoryNav">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('admin-campaign-list')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('campaigns.index') }}" id="campaignNav">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('admin-advertisement-list')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('advertisements.index') }}" id="advertisementNav">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('Advertisements') }}</span>
                                    </a>
                                </div>
                            @endcan
                ...
                @canany(['admin-subscription-list', 'admin-plans-list'])
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion" id="spNav">
                        <span class="menu-link">
                            <span class="menu-icon">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-primary svg-icon-2x">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            ...
                            @can('admin-subscription-list')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('subscription-plans.index') }}"
                                        id="subscriptionPlanNav">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('Subscription Plan') }}</span>
                                    </a>
                                </div>
                            @endcan
                            ...
                            @can('admin-plans-list')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('plans.index') }}" id="planNav">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('Membership Plan') }}</span>
                                    </a>
                                </div>
                            @endcan
                ...
                @canany(['admin-member-list', 'admin-user-list', 'admin-role-list'])
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion" id="auNav">
                        <span class="menu-link">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Commode2.svg-->
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            ...
                            @can('admin-member-list')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('members.index') }}" id="memberNav">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('Members') }}</span>
                                    </a>
                                </div>
                            @endcan
                            ...
                            @can('admin-user-list')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('users.index') }}" id="usersNav">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                            ...
                            @can('admin-role-list')
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('roles.index') }}" id="roleNav">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                ...
                @can('admin-user-list')
                    <div class="menu-item">
                        <a class="menu-link" href="{{ route('settings.index') }}" id="settingNav">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-primary svg-icon-2x">
                                    <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Commode2.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('notification.index') }}" id="settingNav">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Commode2.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                @role('Merchant')
                    @can('report-list')
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion" id="reportNav">
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                    <a class="menu-link" id="offerReportNav"
                                        href="{{ route('merchant-reports.redeemed-coupons') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ __('Redeemed Coupons') }}</span>
                    ...
                    @can('branch-list')
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('merchant-branches.index') }}" id="branchNav">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-primary svg-icon-2x">
                    ...
                    @can('offer-list')
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('merchant-offers.index') }}" id="offerNav">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-primary svg-icon-2x">
                                        <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Commode2.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('my-profile') }}" id="profileNav">
                        <span class="menu-icon">
