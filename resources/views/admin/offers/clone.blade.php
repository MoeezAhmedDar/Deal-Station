            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 fv-row">
                            <!--begin::Label-->
                            <label class="col-12 col-form-label required fw-bold fs-6">Main Offer Description:</label>
                            <!--end::Label-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 fv-row">
                            <!--begin::Label-->
                            <label class="col-12 col-form-label required fw-bold fs-6">Offer Desc Details:</label>
                            <!--end::Label-->
                    ...
                    <div class="row">
                        ...
                        <!--begin::Col-->
                        <div class="col-6 fv-row" id="coupon_type_div" @if ($offer_data->offer_type == 2 || $offer_data->offer_coupon_type == 0) style="display: none;" @endif>
                            <!--begin::Label-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 fv-row">
                            ...
                            <!--end::Label-->
                            {!! Form::date('offer_from', null, ['class' => 'form-control']) !!}
                        </div>
                        <!--begin::Col-->
                        <div class="col-6 fv-row">
                            <!--begin::Label-->
                            ...
                            <!--end::Label-->
                            {!! Form::date('offer_to', null, ['class' => 'form-control']) !!}
                        </div>
                        <!--begin::Col-->
                    </div>
                    <!--end::Input group-->
                ...
                if (result.isConfirmed) {
                    ...
                    if (order && order >= 1 && order <= 5) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.data) {
                                    $("#offers_gallery_table").load(window.location +
                                        " #offers_gallery_table");
