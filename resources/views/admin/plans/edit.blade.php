    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <!--end::Card header-->
                {!! Form::model($plan, ['method' => 'PATCH','route' => ['plans.update', $plan->id], 'class'=>'w-100 position-relative mb-3', 'enctype'=>'multipart/form-data']) !!}
                <!--begin::Card body-->
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="row_<?php echo $x ?>">
                                                <td>
                                                    ...
                                                    <select class="form-control" data-row-id="plan_subscription_<?php echo $x ?>" id="plan_subscription_<?php echo $x ?>" name="plan_subscription[]">
                                                ...
                                                <td>
                                                    <input type="number" step="0.001" min="0" name="plan_subscription_price[]" id="plan_subscription_price_<?php echo $x ?>" value="{{$list_item->subscription_price}}" class="form-control" autocomplete="off" placeholder="{{ __('Price')}}">
                                                </td>
