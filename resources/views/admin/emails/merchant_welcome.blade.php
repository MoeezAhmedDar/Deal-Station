...
<br />
<p>Kindly find below your credentials to access your merchant dashboard and begin the Deal Station journey:</p>
<br />
Email: {{$user['email']}}
<br />
Password: {{$user['password']}}
<br />
<p>Make sure to change your password after you access the dashboard for the first time!</p>
<br />
