                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 fv-row">
                            ...
                            <select class="form-control" name="merchant_id" id="merchant_id" data-control="select2" disabled>
                                ...
                                <option value="{{ $merchant['id'] }}" @if ($branch->merchant_id == $merchant['id']) {{ 'selected' }} @endif>
                                    {{ $merchant['name'] }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-6 fv-row">
                            ...
                            <select class="form-control" name="branch_status" id="branch_status">
                                <option disabled selected>--{{ __('Select an Option') }}--</option>
                                <option value="1" @if ($branch->branch_status == 1) {{ 'selected' }} @endif>
                                    Active</option>
                                <option value="2" @if ($branch->branch_status == 2) {{ 'selected' }} @endif>
                                    Inactive</option>
                            </select>
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row">
                        <div class="col-lg-6 fv-row">
                            ...
                            <select class="form-control" name="branch_city" id="branch_city" data-control="select2">
                                ...
                                <option value="{{ $city['id'] }}" @if ($branch->branch_city == $city['id']) {{ 'selected' }} @endif>
                                    {{ $city['city_name'] }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row">
                            <div class="col-lg-12 fv-row">
                                ...
                                <!--end::Label-->
                                {!! Form::email('email', $cashier->email, ['placeholder' => __('Email'), 'class' => 'form-control']) !!}
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
...
<script>
    $(document).ready(function() {
        ...
        var editBranchForm = $("#edit-branch-form");
