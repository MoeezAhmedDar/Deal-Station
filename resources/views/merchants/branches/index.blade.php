                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <!--begin::Add user-->
                            <a href="{{ route('merchant-branches.create') }}" class="btn btn-primary">{{ __('Add Branch') }}</a>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                    </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="branches_table">
                        ...
                        <tbody class="text-dark-600 fw-bold">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('merchant-branches.show', $data->branch_uniid) }}" class="btn btn-icon btn-sm btn-color-dark">
                                        <i class="far fa-eye"></i>
                                    </a>
                                    @can('branch-edit')
                                    <a class="btn btn-icon btn-sm btn-color-dark" href="{{ route('merchant-branches.edit', $data->branch_uniid) }}">
                                        <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                                    ...
                                    @endcan
                                    @can('branch-delete')
                                    <button type="button" class="btn btn-icon btn-sm btn-color-dark" onclick="removeFunc('{{ $data->branch_uniid }}')">
        ...
        if (id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('merchant-branches.destroy', ':id') }}";
