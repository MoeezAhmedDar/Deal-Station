    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <!--end::Card header-->
                {!! Form::model($branch, ['method' => 'PATCH','route' => ['merchant-branches.update', $branch->branch_uniid], 'class'=>'w-100 position-relative mb-3', 'enctype'=>'multipart/form-data']) !!}
                <!--begin::Card body-->
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row">
                            <div class="col-lg-12 fv-row">
                                ...
                                <!--end::Label-->
                                {!! Form::email('email', $cashier->email, array('placeholder' => __('Email'),'class' => 'form-control')) !!}
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
