    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <!--end::Card header-->
                {!! Form::open(array('route' => 'merchant-offers.store','method'=>'POST', 'class'=>'w-100 position-relative mb-3', 'enctype'=>'multipart/form-data', 'id'=>'offer-form')) !!}
                <!--begin::Card body-->
                <div class="card-body pt-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 fv-row" id="code_generation_div" style="display: none;">
                            ...
                            <div class="radio-inline">
                                <label class="radio">
                                    <input type="radio" name="offer_code_generation" value="1" />
                                    <span></span>
                                    {{ __('CSV Upload Link')}}
                                </label>
                                <br>
                                <label class="radio">
                                    <input type="radio" name="offer_code_generation" value="2" />
                                    <span></span>
                                    {{ __('Codes by DS')}}
                                </label>
                            </div>
...
<script>
    ...
    var merchant = "{{ Auth::user()->id }}";
    LoadMerchantBranches(merchant);
